...
## This is only the API, the frontend is in [this repo](https://github.com/bahirhakimy/hello-react-frontend)
...
```bash
git clone https://github.com/BahirHakimy/hello-rails-react.git
```
